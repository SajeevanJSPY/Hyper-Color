...
const ArrowDown = ({ settingDirection }: icontype) => {
    return (
        <div onClick={() => {
            ...
            <svg xmlns="http://www.w3.org/2000/org" className="group-hover:text-pink-500 h-6 w-6 text-white rotate-90" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
